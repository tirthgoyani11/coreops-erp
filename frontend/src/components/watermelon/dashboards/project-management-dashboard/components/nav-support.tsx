            ...
            {support.map((item) => (
              <SidebarMenuItem key={item.name}>
                <SidebarMenuButton
                  ...
                  className="text-neutral-500 dark:text-neutral-400 text-xs h-8 font-medium data-[active=true]:border data-[active=true]:border-border data-[active=true]:text-neutral-600 dark:data-[active=true]:text-neutral-300 hover:border hover:border-border hover:text-neutral-600 dark:hover:text-neutral-300"
                >
                  <a
