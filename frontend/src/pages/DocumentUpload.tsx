            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 shadow-sm space-y-6">
                ...
                <div className="flex justify-end pt-4">
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-2 bg-[var(--primary)] text-black font-semibold rounded-md shadow-[0_0_10px_var(--primary-glow)] hover:bg-[var(--primary)]/90 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
